...
>>>>>>> 6fed9a126110455c69ac6362b0db87f231f1f22b
        ...
        <Button
          as={Link}
<<<<<<< HEAD
          href={`/ringbots/${typebot?.id}/theme`}
=======
...
>>>>>>> 6fed9a126110455c69ac6362b0db87f231f1f22b
        ...
        <Button
          as={Link}
<<<<<<< HEAD
          href={`/ringbots/${typebot?.id}/settings`}
=======
              ...
              href={
                !user
                  ? {
                      ...
                      query: {
<<<<<<< HEAD
                        redirectPath: `/ringbots/${typebot.id}/duplicate`,
                      },
                    }
                  : `/ringbots/${typebot.id}/duplicate`
=======
