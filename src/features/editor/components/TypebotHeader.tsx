    ...
    <HStack {...props}>
      ...
      {currentUserMode === 'guest' && (
        <Button
          as={Link}
<<<<<<< HEAD
          href={`/ringbots/${typebot?.id}/duplicate`}
=======
...
>>>>>>> 6fed9a126110455c69ac6362b0db87f231f1f22b
      ...
      <Button
        as={Link}
<<<<<<< HEAD
        href={`/ringbots/${typebotId}/settings`}
=======
...
>>>>>>> 6fed9a126110455c69ac6362b0db87f231f1f22b
      ...
      {isResultsDisplayed && (
        <Button
          as={Link}
<<<<<<< HEAD
          href={`/ringbots/${typebotId}/results`}
=======
